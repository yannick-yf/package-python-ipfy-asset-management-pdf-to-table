...
def test_textract_zip_process_exemple_CA_CC():
...
def test_textract_zip_process_exemple_CA_CEL():
...
def test_textract_zip_process_exemple_BB_CC():
...
def test_textract_zip_process_exemple_CA_LVTA():
